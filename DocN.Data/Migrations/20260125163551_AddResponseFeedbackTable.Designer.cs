...
namespace DocN.Data.Migrations
{
    ...
    [Migration("20260125163551_AddResponseFeedbackTable")]
    partial class AddResponseFeedbackTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocN.Data.Models.AIConfiguration", b =>
                {
                    ...
                    b.Property<string>("GroqChatModel")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("GroqEndpoint")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsActive")
                        .HasColumnType("bit");

                    b.Property<double>("MMRLambda")
                        .HasColumnType("float");
                    ...
                    b.Property<int?>("MetadataExtractionProvider")
                        .HasColumnType("int");

                    b.Property<string>("OllamaChatModel")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DocN.Data.Models.DashboardWidget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DocN.Data.Models.Document", b =>
                {
                    ...
                    b.Property<string>("PreviousWorkflowState")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DocN.Data.Models.DocumentGroupShare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DocN.Data.Models.GoldenDataset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GoldenDatasets");
                });

            modelBuilder.Entity("DocN.Data.Models.GoldenDatasetEvaluationRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double>("AverageAnswerRelevancyScore")
                        .HasColumnType("float");

                    b.Property<double>("AverageConfidenceScore")
                        .HasColumnType("float");

                    b.Property<double>("AverageContextPrecisionScore")
                        .HasColumnType("float");

                    b.Property<double>("AverageContextRecallScore")
                        .HasColumnType("float");

                    b.Property<double>("AverageFaithfulnessScore")
                        .HasColumnType("float");

                    b.Property<double>("CitationVerificationRate")
                        .HasColumnType("float");
                    ...
                    b.Property<int>("EvaluatedSamples")
                        .HasColumnType("int");

                    b.Property<string>("FailedSampleIdsJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("FailedSamples")
                        .HasColumnType("int");

                    b.Property<int>("GoldenDatasetId")
                        .HasColumnType("int");

                    b.Property<double>("HallucinationRate")
                        .HasColumnType("float");

                    b.Property<double>("LowConfidenceRate")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("OverallRAGASScore")
                        .HasColumnType("float");
                    ...
                    b.HasIndex("GoldenDatasetId");

                    b.HasIndex("TenantId");

                    b.HasIndex("GoldenDatasetId", "EvaluatedAt");

                    b.ToTable("GoldenDatasetEvaluationRecords");
                });

            modelBuilder.Entity("DocN.Data.Models.GoldenDatasetSample", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RelevantDocumentIdsJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("GoldenDatasetId", "IsActive");

                    b.ToTable("GoldenDatasetSamples");
                });
            ...
            modelBuilder.Entity("DocN.Data.Models.ResponseFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DocN.Data.Models.SavedSearch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DocN.Data.Models.UserActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DocN.Data.Models.UserGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DocN.Data.Models.UserGroupMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DocN.Data.Models.DocumentGroupShare", b =>
                {
                    ...
                    b.HasOne("DocN.Data.Models.UserGroup", "Group")
            ...
            modelBuilder.Entity("DocN.Data.Models.GoldenDatasetEvaluationRecord", b =>
                {
                    b.HasOne("DocN.Data.Models.GoldenDataset", "GoldenDataset")
                        .WithMany("EvaluationRecords")
                        .HasForeignKey("GoldenDatasetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
